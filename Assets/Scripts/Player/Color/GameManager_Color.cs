...
public class GameManager_Color : MonoBehaviour
{
    ...
    [SerializeField] private bool[] _colors = { true, false, false, false, false, false, false, false, false }; //1 основа и 8 цветов (должно быть), всего 9
    [Space(height: 5f)] 
    ...
    //[SerializeField] private Collider2D[] _collidersGray;
